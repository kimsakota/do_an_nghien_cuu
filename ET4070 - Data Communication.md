...
# ET4070 - Data Communication

> [!abstract] Exit capability
> Liên hệ throughput, latency, loss và queueing với workload mạng. ^course-contract

## Module map

| Module | Topic | Status |
|---|---|---|
| M01 | Signals and Channels | planned |
| M02 | Encoding and Modulation | planned |
| M03 | Error Detection | planned |
| M04 | Multiplexing | planned |
| M05 | Queueing Basics | planned |
| M06 | Link Performance | planned |
