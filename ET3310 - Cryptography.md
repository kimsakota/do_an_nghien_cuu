...
> Nhận diện security cost/boundary mà không làm lệch trọng tâm state engine. ^course-contract

## Module map

| Module | Topic | Status |
|---|---|---|
| M01 | Security Goals | planned |
| M02 | Symmetric Crypto | planned |
| M03 | Hash and MAC | planned |
| M04 | Public Key | planned |
| M05 | Key Management | planned |
| M06 | Protocol Threats | planned |
